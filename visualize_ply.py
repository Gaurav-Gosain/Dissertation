...
if __name__ == "__main__":
    ...
    pcd = o3d.io.read_point_cloud(f"outputs_012/outputs_012/mvsnet075_l3.ply")
    ...
    param = o3d.io.read_pinhole_camera_parameters(f"viewpoint.json")
    ctr.convert_from_pinhole_camera_parameters(param)
    #     vis.run()
    # elif args.save_viewpoint:
    vis.run()
    # param = ctr.convert_to_pinhole_camera_parameters()
    # o3d.io.write_pinhole_camera_parameters(f"viewpoint.json", param)
    # else:
    # vis.run()
    vis.destroy_window()
